...
<body class="easyui-layout">
    <div data-options="region:'west',title:'菜单',split:true,minWidth:220" style="width:100px;">
        <ul id="tt" class="easyui-tree">
            <li>
                <span>商品管理</span>
                <ul>
                    <li data-options="attributes:{'url':'product_category_list'}"><span>商品分类列表</span></li>
